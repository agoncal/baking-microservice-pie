...
== The Generated Java Feign Client
...
== Producing the Feign Client

[source,java]
----
include::{demo02bookapidir}/src/main/java/org/bakingpie/book/client/api/NumbersApiProducer.java[tags=adocSnippet]
----

== Invoking the Number API with Feign Client

[source,java,indent=0]
----
include::{demo02bookapidir}/src/main/java/org/bakingpie/book/rest/BookResource.java[tags=adocCall;adocInject;!adocSkip]
----
