...
This Demo uses applies a Load Balancer when calling the `number-api`, using 
[Netflix Ribbon](https://github.com/Netflix/ribbon) to have multiple instances of `number-api` and balance between the 
registered and healthy instances in Consul.
