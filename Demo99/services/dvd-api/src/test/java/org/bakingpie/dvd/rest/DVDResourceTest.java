...
public class DVDResourceTest {
    ...
    public void setUp() throws Exception {
        ...
        webTarget = client.target(URI.create(new URL(base, "api/dvds").toExternalForm()));
    }
    ...
    public void create() throws Exception {
        final DVD dvd = new DVD("Michael Bay", "Transformers", 2007, "Sci-Fi", 7);
        final Response response = webTarget.request().post(entity(dvd, APPLICATION_JSON_TYPE));
    ...
    public void update() throws Exception {
        ...
        final Response response = webTarget.path("{id}")
                                           ...
                                           .request()
                                           .put(entity(dvd, APPLICATION_JSON_TYPE));
